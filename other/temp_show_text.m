...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function []=temp_show_text(window, current_session_info, text)
    ...
    display_text(window, strcat(text, ' Press Enter to continue.'), 30, 0, 0, current_session_info.BLACK_COLOR);
    %[display_text_timestamp, display_text_onset_time]=Screen('Flip', window);
    ...
    %[key_pressed, rt] = get_keyboard_response(accepted_keys, display_text_onset_time, time_limit_ms);
end